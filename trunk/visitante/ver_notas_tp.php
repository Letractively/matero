...
//Valido que venga el id_trabajo y el id_comision
if((empty($id_trabajo))||(empty($id_comision))){
...
//Obtengo las notas del tp
$consulta=mysql_query("select trabajo_practico_notas.*, alumno.*
                       from trabajo_practico_notas, alumno, alumno_comision, trabajo_practico, comision, tp_comision
                       where trabajo_practico_notas.id_tp=$id_trabajo
                       and trabajo_practico.id_tp=trabajo_practico_notas.id_tp
                       ...
                       and comision.id_catedra=$id_catedra
                       and comision.id_comision=$id_comision
                       and alumno.lib_univ=trabajo_practico_notas.id_alumno
                       order by alumno.apellido, alumno.nombre");

//Si no encuentran notas, vuelve a la pagina de tps
...
//Obtengo los datos del tp
$consulta2=mysql_query("select trabajo_practico.* from trabajo_practico, comision, tp_comision
                        where trabajo_practico.id_tp=$id_trabajo
                        and trabajo_practico.id_tp=tp_comision.id_tp
                        and tp_comision.id_comision=comision.id_comision
                        and comision.id_catedra=$id_catedra");
$eltp=mysql_fetch_array($consulta2);

//Seteo del encabezado
set_var('titulo',$eltp['nombre']);
set_var('comentario',$eltp['descrip']);

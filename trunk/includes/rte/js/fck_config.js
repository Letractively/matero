...
//##
//## When the user presses <ENTER> inserts a <BR> tag instead of a <P>// está bueno
//##
config.UseBROnCarriageReturn	= false ;

//## Spaces (&nbsp;) to add on TAB. está bueno
config.TabSpaces = 4 ;
...
/*config.ToolbarSets["Matero"] = [
	['Cut','Copy','Paste','PasteText','PasteWord','-','Find','-','Undo','Redo','-','SelectAll','RemoveFormat','-','Link','RemoveLink','-','SpecialChar','Smiley'] ,
	['Bold','Italic','Underline','-','JustifyLeft','JustifyCenter','JustifyRight','JustifyFull','-','InsertOrderedList','InsertUnorderedList','-','Zoom','-','TextColor','BGColor'] ,
	['Font','-','FontSize','-','EditSource']
] ;*/

config.ToolbarSets["Matero"] = [
	['Cut','Copy','Paste','-','Find','-','Undo','Redo','-','SelectAll','RemoveFormat','-','Link','RemoveLink','-','SpecialChar','Smiley'] ,
	['Bold','Italic','Underline','-','JustifyLeft','JustifyCenter','JustifyRight','JustifyFull','-','InsertOrderedList','InsertUnorderedList','-','Zoom','-','TextColor','BGColor'] ,
	['Font','-','FontSize','-','EditSource']
] ;

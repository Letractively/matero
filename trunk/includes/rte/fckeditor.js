 ...
 */
// corregir el path deacuerdo a donde deje el directorio FCKeditor/
// guido
//var FCKeditorBasePath = '/webnueva/proyectos/matero/includes/rte/' ;
var FCKeditorBasePath = '/matero/includes/rte/' ;
...
function FCKeditor(instanceName, width, height, toolbarSet, value)
{
	...
	this.Value			= value			|| '' ;  // aca va el texto por defecto
...
FCKeditor.prototype.Create = function()
{
	...
	else
	{
		...
		document.write('<TEXTAREA name="' + this.InstanceName + '" rows="4" cols="40" class="EditorArea" style="WIDTH: ' + sWidth + '; HEIGHT: ' + sHeight + '" wrap="virtual">' + HTMLEncode( this.Value ) + '<\/TEXTAREA>') ;
	}
}

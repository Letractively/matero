...
function mostrar_calendario($mes,$ano){
	...
	echo "<a style=color:white;text-decoration:none href=index.php?$parametros_formulario&nuevo_mes=$mes_anterior&nuevo_ano=$ano_anterior&formulario_destino=$formulario_destino&ano_destino=$ano_destino&mes_destino=$mes_destino&dia_destino=$dia_destino>&lt;&lt;</a></td>";
	...
	echo "<a style=color:white;text-decoration:none href=index.php?$parametros_formulario&nuevo_mes=$mes_siguiente&nuevo_ano=$ano_siguiente&formulario_destino=$formulario_destino&ano_destino=$ano_destino&mes_destino=$mes_destino&dia_destino=$dia_destino>&gt;&gt;</a></td></tr></table></td></tr>";
	echo '	<tr>
...
echo '
	...
	<tr><form action="index.php?formulario_destino=' . $formulario_destino . '&ano_destino='. $ano_destino . '&mes_destino=' . $mes_destino . '&dia_destino='. $dia_destino . '" method="POST" >';
	//<tr><form action="index.php?' . $parametros_formulario . '" method="POST" >';
echo '
    <td align="center" valign="top">
		Mes: <br>
		<select name=nuevo_mes onChange="submit()";>
		<option value="1"';
if ($mes==1)
 echo "selected";
echo'>Enero
...
echo '		
	    <td align="center" valign="top">
		A&ntilde;o: <br>
		<select name=nuevo_ano onChange="submit()";>';

...
lang["InsertLink"]			= "Vložit/změnit odkaz" ;
lang["RemoveLink"]			= "Odstranit odkaz" ;
lang["InsertImage"]			= "Vložit/změnit obrázek" ;
lang["InsertTable"]			= "Vložit/změnit tabulku" ;
...
lang["InsertRow"]			= "Vložit řádek" ;
lang["DeleteRows"]			= "Smazat řádek" ;
lang["InsertColumn"]		= "Vložit sloupec" ;
lang["DeleteColumns"]		= "Smazat sloupec" ;
lang["InsertCell"]			= "Vložit buňku" ;
lang["DeleteCells"]			= "Smazat buňky" ;
lang["MergeCells"]			= "Sloučit buňky" ;
lang["SplitCell"]			= "Rozdělit buňku" ;
lang["CellProperties"]		= "Vlastnosti buňky" ;
...
lang["Done"]				= "Hotovo" ;
lang["PasteWordConfirm"]	= "Text, který právě vkládáte do dokumentu, pochází pravděpodobně z aplikace MS Word.\nChcete provést vyčištění zdojového kódu?" ;
lang["NotCompatiblePaste"]	= "Tento příkaz je funkční pouze v IE verze 5.5 a vyšší. Chcete vložit text bez vyčištění?" ;

// Dialogs
lang["DlgBtnOK"]			= "OK" ;
lang["DlgBtnCancel"]		= "Zrušit" ;
lang["DlgBtnClose"]			= "Zavřít" ;

// Image Dialog
lang["DlgImgTitleInsert"]	= "Vložit obrázek" ;
lang["DlgImgTitleEdit"]		= "Změnit obrázek" ;
...
lang["DlgImgWidth"]			= "Šířka" ;
lang["DlgImgHeight"]		= "Výška" ;
lang["DlgImgLockRatio"]		= "Zachovat poměr stran" ;
lang["DlgBtnResetSize"]		= "Původní velikost" ;
...
lang["DlgTableRows"]		= "Řádky" ;
lang["DlgTableColumns"]		= "Sloupce" ;
lang["DlgTableBorder"]		= "Tloušťka okrajů" ;
lang["DlgTableAlign"]		= "Zarovnání" ;
lang["DlgTableAlignNotSet"]	= "<nenastaveno>" ;
lang["DlgTableAlignLeft"]	= "Vlevo" ;
lang["DlgTableAlignCenter"]	= "Na střed" ;
lang["DlgTableAlignRight"]	= "Vpravo" ;
lang["DlgTableWidth"]		= "Šířka" ;
lang["DlgTableWidthPx"]		= "pixelů" ;
lang["DlgTableWidthPc"]		= "procent" ;
lang["DlgTableHeight"]		= "Výška" ;
lang["DlgTableCellSpace"]	= "Mezera mezi buňkami" ;
lang["DlgTableCellPad"]		= "Odsazení v buňce" ;
lang["DlgTableCaption"]		= "Titulek" ;

// Table Cell Dialog
lang["DlgCellTitle"]		= "Vlastnosti buňky" ;
lang["DlgCellWidth"]		= "Šířka" ;
lang["DlgCellWidthPx"]		= "pixelů" ;
...
lang["DlgCellHorAlignCenter"]	= "Na střed" ;
...
lang["DlgCellRowSpan"]		= "Spřežení řádků" ;
lang["DlgCellCollSpan"]		= "Spřežení sloupců" ;
lang["DlgCellBackColor"]	= "Barva pozadí" ;
lang["DlgCellBorderColor"]	= "Barva okrajů" ;
